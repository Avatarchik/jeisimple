...
public struct SlotWinSpin {
	public int totalWon;
	public int totalWonAdjusted;
}
...
public class SlotWinData {
	...
	public SlotWinData(int line) {
		...
		readout = System.String.Empty;
		symbols = new List<GameObject>();
	}
	public void setPaid(int pay) {
		paid = pay;
		readout = matches + " " + setName + " pays " + pay;
	}
}

public struct SlotScatterHitData {
	public bool wasAnticipating;
	public int reel;
	public int hits;
	public SetsType setType;
	public int setIndex;
...
public class SlotGlobals {
	...
	public const string PRODUCT_VERSION = "1.11";
	public const string COMPANY = "Bulkhead Studios 2015";
	public const string MATH_PATH = "Assets/SlotsCreatorPro/Math/";
}
public class SlotHelp {
	...
	public const string REEL_PADDING = "Specify a space between each reel horizontally, defined as a percentage of the symbol width. 0 = no padding.";
	public const string SYMBOL_PADDING = "Specify a space between each symbol vertically, defined as a percentage of the symbol height. 0 = no padding.";
	...
	public const string REEL_LINEBOX_DRAWING = "If you clamp this, winboxes will not be displayed on any reel beyond the clipping range.";
	...
	public const string LINK_SYMBOL = "Check this box if you want this symbol to be linked in a chain to another.";
	public const string LINK_IDENTIFIER = "Specify the name of the identifier group this symbol should be a part of.";
	public const string LINK_POSITION = "Specify the position of this symbol in the link chain.";
	public const string LINK_NEXT = "Specify the next symbol in this chain, starting from the Bottom up to the Top.";
	// SYMBOL SET SETUP
